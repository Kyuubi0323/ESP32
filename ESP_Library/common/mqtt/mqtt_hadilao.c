...
char version[10];
char topic_commands_data[50] = "MANDEVICES_RESP";
char topic_commands_ver[20] = "1.0";
...
{   esp_mqtt_event_handle_t event = event_data;
    ...
    cJSON_AddNumberToObject(root, "temp", 12);
    cJSON_AddNumberToObject(root, "batt", 12);
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
    {
        ...
        esp_mqtt_client_publish(client, topic_commands_ver, ver_json, strlen(ver_json), 0, 0);
